...
export declare class NgbDatepickerNavigationSelect implements AfterViewChecked {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NgbDatepickerNavigationSelect, "ngb-datepicker-navigation-select", never, { "date": "date"; "disabled": "disabled"; "months": "months"; "years": "years"; }, { "select": "select"; }, never, never, never>;
}
